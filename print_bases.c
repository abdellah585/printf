...
/**
 * print_octal - prints an octal representation of an unsigned int.
 * @list: va_list of integers to be printed.
 * Return: number of printed characters.
 */
...
/**
 * print_HEX - Prints a hexadecimal representation of
 * an unsigned int in uppercase.
 * @list: va_list of integers to be printed.
 * Return: number of printed characters.
 */
int print_HEX(va_list list)
 ...
 * Return: number of printed characters (including "0x").
 */
